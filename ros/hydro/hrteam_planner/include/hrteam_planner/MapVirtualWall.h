 ...
 *      Author: tuna
 */
#ifndef HRTEAM_MAP_VIRTUAL_WALL_H_
#define HRTEAM_MAP_VIRTUAL_WALL_H_
...
namespace hrteam_planner {
  ...
  public:
    ...
    MapVirtualWall(std::string i, int bSize, double fx, double fy, double sx, double sy);
