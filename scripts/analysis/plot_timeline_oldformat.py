...
colors = {'moving':  [0.619, 0.835, 0.757],          # 'green'
          'waiting': [0.952, 0.612, 0.764],         # 'red'
          'delay':   [0.945, 0.392, 0.424],           # 'blue'
          'idle':    [0.980, 0.757, 0.455],            # violet
          'deliberation': [0.153, 0.643, 0.867],    # grey
          'nap': [0.392, 0.392, 0.392],         # pink
          'execution': [0.0, 0.0, 0.0, 0.0]}  # transparent
...
def plot_timeline(run_msgs, plot_title, plot_filename):
    ...
    ax.set_yticklabels(display_names[::-1])
