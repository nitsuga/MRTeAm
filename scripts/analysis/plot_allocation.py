...
task_files = ['SR-IT-SA-scenario1.yaml']
...
def main(argv):
    ...
    for i, bag_path in enumerate(bag_paths):
        ...
        print "map: {0}, start_config: {1}, mechanism: {2}, task_file: {3}, remainder: {4}".format(map,
                                                                                                   start_config,
                                                                                                   mechanism,
                                                                                                   task_file,
                                                                                                   remainder)
    ...
    for task_file in task_files:
        print "task_file: {0}".format(task_file)

        # Set plot title
        plt.title("Task Allocation, eschneider '{0}' ".format(task_file))
        ...
        for start_config in start_configs:
            ...
            for mechanism in mechanisms:
                print "mechanism: {0}".format(mechanism)
                ...
                # pp.pprint("exps: {0}".format(pp.pformat(exps)))
