...
#        print('EXECUTION_PHASE_TIME:')
        ...
        for award_msg in run_msgs['/tasks/award']:
            ...
            for task in award_msg.tasks:
                ...
                row_fields['ROBOT{0}_AWARDED_TASK'.format(award_msg.robot_id)] = task.task.task_id
...
#            print('{0} delay time:'.format(r_name))
            ...
            for status_msg in r_status_msgs:
			    ...
			    row_fields['ROBOT{0}_COMPLETED_TASK'.format(award_msg.robot_id)] = status_msg.task_id
                        except ValueError:
		...
		row_fields['ROBOT{0}_UNCOMPLETED_TASK'.format(award_msg.robot_id)] = pp.pformat(robot.tasks)
                inconsistent_tasks = True
